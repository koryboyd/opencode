...
import { RiskClassifier } from "../../src/session/risk"
import { AutoDream } from "../../src/memory/autodream"
import { SkepticalMemory } from "../../src/memory/skeptical"
...
function makeHttp() {
  const deps = Layer.mergeAll(
    ...
    status,
    RiskClassifier.defaultLayer,
    AutoDream.defaultLayer,
    SkepticalMemory.defaultLayer,
